  ...
  return (
    <section className=" w-75 px-5 ">
      ...
      <div className="d-flex flex-column align-items-center">
        ...
        <p className="m-0 p-2 border  border-dark-subtle  w-100">{user?.Bio}</p>

        <div className="w-100 mt-4">
          <p className="text-start m-0 ">Full Name</p>
          <p
            className="text-start m-0 p-2 border border-dark-subtle   bg-opacity-10 "
        ...
        <div className="w-100 mt-3">
          ...
          <p
            className="text-start m-0 text-lowercase p-2 border border-dark-subtle  bg-opacity-10 "
            style={{ backgroundColor: "#F96167" }}
          >
            {" "}
            {user?.profile?.email}
